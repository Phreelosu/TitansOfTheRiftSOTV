...
namespace RiftTitansMod.Modules.Survivors {
	...
	{
		internal static int spawnCost = 1000;
		...
		public const string bodyName = "BaronNashorBody";
		...
		{
			bool flag = true;
			characterPrefab = Prefabs.CreatePrefab("BaronNashorBody", "mdlBaron", new BodyInfo
			{
				moveSpeed = 0f,
				acceleration = 30f,
				armor = 30f,
				armorGrowth = 0f,
				bodyName = "BaronNashorBody",
				bodyNameToken = "NDP_BARON_BODY_NAME",
				bodyColor = Color.cyan,
				characterPortrait = Assets.LoadCharacterIcon("Baron"),
				...
				jumpCount = 0,
				maxHealth = 3000f,
				subtitleNameToken = "NDP_BARON_BODY_SUBTITLE",
				podPrefab = Resources.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod"),
				cameraPivotPosition = new Vector3(0f, 27f, 0f),
				aimOriginPosition = new Vector3(0f, 17f, 5f)
			});
			Material material = Assets.CreateMaterial("matBaron", 0.0001f);
			bodyRendererIndex = 0;
			...
			component2.initialStateType = new SerializableEntityStateType(typeof(RiftTitansMod.SkillStates.Baron.SpawnState));
			CharacterDeathBehavior component3 = characterPrefab.GetComponent<CharacterDeathBehavior>();
			component3.deathState = new SerializableEntityStateType(typeof(RiftTitansMod.SkillStates.Baron.DeathState));
			...
			component7.baseFootstepString = "";
			component7.footstepDustPrefab = null;
			...
			AimAnimator component9 = characterPrefab.GetComponent<ModelLocator>().modelTransform.GetComponent<AimAnimator>();
			component9.yawRangeMax = 120f;
			component9.yawRangeMin = -120f;
			component9.giveupDuration = 9999f;
			EntityLocator entityLocator = characterPrefab.AddComponent<EntityLocator>();
			entityLocator.entity = characterPrefab;
			enemyMaster = CreateMaster(characterPrefab, "BaronNashorMaster");
			CreateSpawnCard();
		}
		...
		private static GameObject CreateMaster(GameObject bodyPrefab, string masterName)
		{
			...
			gameObject.GetComponent<BaseAI>().aimVectorMaxSpeed = 60f;
			AISkillDriver aISkillDriver = gameObject.AddComponent<AISkillDriver>();
			aISkillDriver.customName = "Spit";
			...
			aISkillDriver.maxDistance = 150f;
			...
			aISkillDriver2.customName = "Tentacles";
			...
			aISkillDriver2.maxDistance = 125f;
			...
			aISkillDriver2.moveInputScale = 0f;
			...
			aISkillDriver3.customName = "Cone";
			...
			aISkillDriver4.customName = "Chase";
		...
		private static void CreateSpawnCard()
		{
			...
			characterSpawnCard.name = "cscBaronNashor";
			...
			characterSpawnCard.occupyPosition = true;
			...
			{
				DirectorAPI.DirectorCardHolder toAdd = ssi.GetMinStages() == 0 ?  RiftTitansPlugin.BaronCard : RiftTitansPlugin.BaronLoopCard;
		...
		private static void CreateSkills()
		{
			...
			skillDefInfo.activationState = new SerializableEntityStateType(typeof(Spit));
			...
			skillDefInfo.skillDescriptionToken = text + "_RELIC_BODY_SECONDARY_BUFFDISC_DESCRIPTION";
			skillDefInfo.skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texLunarEncore1Icon");
			skillDefInfo.activationState = new SerializableEntityStateType(typeof(SpitCone));
			skillDefInfo.activationStateMachineName = "Body";
			skillDefInfo.baseMaxStock = 1;
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-1.38985f, 2.1829f, 1.40206f),
						localAngles = new Vector3(300.3736f, 174.5427f, 348.4066f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteHorn"),
						childName = "Head",
						localPos = new Vector3(1.39161f, 2.01396f, -0.18736f),
						localAngles = new Vector3(303.1637f, 214.0948f, 354.524f),
						localScale = new Vector3(2f, 2f, 2f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteHorn"),
						childName = "HeadL",
						localPos = new Vector3(-0.15412f, 0.51297f, 0.0921f),
						localAngles = new Vector3(31.74674f, 24.69264f, 129.7772f),
						localScale = new Vector3(1f, 1f, 1f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteHorn"),
						childName = "HeadL",
						localPos = new Vector3(67f / 160f, 0.77015f, 0.09303f),
						localAngles = new Vector3(61.71302f, 312.8923f, 209.7728f),
						localScale = new Vector3(1f, 1f, 1f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteHorn"),
						childName = "HeadR",
						localPos = new Vector3(-0.21507f, 0.74707f, -0.21124f),
						localAngles = new Vector3(52.49652f, 159.7765f, 241.9986f),
						localScale = new Vector3(1f, 1f, 1f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteHorn"),
						childName = "HeadR",
						localPos = new Vector3(0.79912f, 0.59592f, 0.02693f),
						localAngles = new Vector3(18.45959f, 175.1937f, 134.019f),
						localScale = new Vector3(1f, 1f, 1f),
						limbMask = LimbFlags.None
					}
					}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.08256f, -1.55875f, 2.35047f),
						localAngles = new Vector3(339.0468f, 359.9214f, 180.5965f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteRhinoHorn"),
						childName = "Head",
						localPos = new Vector3(0.00987f, 2.05991f, 2.56368f),
						localAngles = new Vector3(349.9549f, 0.06977f, 180.1206f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteRhinoHorn"),
						childName = "HeadL",
						localPos = new Vector3(-0.10673f, 0.50514f, 0.57655f),
						localAngles = new Vector3(2.21731f, 0.15627f, 180.5575f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteRhinoHorn"),
						childName = "HeadL",
						localPos = new Vector3(0.00763f, 1.52114f, 0.36258f),
						localAngles = new Vector3(333.2837f, 0.03105f, 180.1329f),
						localScale = new Vector3(3f, 3f, 2.5f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteRhinoHorn"),
						childName = "HeadR",
						localPos = new Vector3(-0.10669f, 0.45763f, -0.64608f),
						localAngles = new Vector3(2.21731f, 180f, 180f),
						localScale = new Vector3(1.7f, 1.7f, 1.7f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteRhinoHorn"),
						childName = "HeadR",
						localPos = new Vector3(0.00761f, 1.88231f, -0.35467f),
						localAngles = new Vector3(333.2837f, 180f, 180.1329f),
						localScale = new Vector3(3f, 3f, 2.5f),
						limbMask = LimbFlags.None
					}
					}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.02073f, 0.86189f, 4.49602f),
						localAngles = new Vector3(26.22792f, 0f, 180f),
						localScale = new Vector3(0.6f, 0.6f, 0.8f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteIceCrown"),
						childName = "HeadR",
						localPos = new Vector3(-0.02066f, 1.67486f, -1.26655f),
						localAngles = new Vector3(346.9752f, 180f, 180f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteIceCrown"),
						childName = "HeadL",
						localPos = new Vector3(-0.02066f, 0.8336f, 1.58787f),
						localAngles = new Vector3(346.9752f, 0f, 180f),
						localScale = new Vector3(0.2f, 0.2f, 0.2f),
						limbMask = LimbFlags.None
					}
					}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.26196f, 0.60626f, 2.26806f),
						localAngles = new Vector3(0f, 353.4143f, 0f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteUrchinCrown"),
						childName = "HeadR",
						localPos = new Vector3(-0.02942f, 0.60617f, -0.44402f),
						localAngles = new Vector3(0f, 180f, 0f),
						localScale = new Vector3(0.5f, 0.5f, 0.6f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteUrchinCrown"),
						childName = "HeadL",
						localPos = new Vector3(-0.02942f, 0.60621f, 0.25474f),
						localAngles = new Vector3(0f, 353.4143f, 0f),
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.04868f, 1.24307f, 4.00788f),
						localAngles = new Vector3(7.48415f, 0f, 180f),
						localScale = new Vector3(1f, 1f, 1f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteStealthCrown"),
						childName = "HeadL",
						localPos = new Vector3(-0.04867f, 0.76067f, 1.1755f),
						localAngles = new Vector3(352.5304f, 0f, 180f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteStealthCrown"),
						childName = "HeadR",
						localPos = new Vector3(-0.04864f, 1.23189f, -0.8842f),
						localAngles = new Vector3(352.5304f, 180f, 180f),
						localScale = new Vector3(0.4f, 0.4f, 0.4f),
						limbMask = LimbFlags.None
					}
					}

...
namespace RiftTitansMod.Modules.Survivors {
	...
	{
		internal static int spawnCost = 15;
		...
		public const string bodyName = "ChickenBody";
		...
		{
			bool flag = true;
			characterPrefab = Prefabs.CreatePrefab("ChickenBody", "mdlChicken", new BodyInfo
			{
				moveSpeed = 13f,
				acceleration = 30f,
				armor = 0f,
				...
				bodyNameToken = "NDP_CHICKEN_BODY_NAME",
				bodyColor = Color.cyan,
				characterPortrait = Assets.LoadCharacterIcon("Chicken"),
				...
				jumpCount = 1,
				maxHealth = 150f,
				subtitleNameToken = "NDP_CHICKEN_BODY_SUBTITLE",
				podPrefab = Resources.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod"),
				cameraPivotPosition = new Vector3(0f, 3f, 0f),
				aimOriginPosition = new Vector3(0f, 2f, 0f)
			});
			Material material = Assets.CreateMaterial("matChicken", 2.75E-05f);
			bodyRendererIndex = 0;
			...
			component2.initialStateType = new SerializableEntityStateType(typeof(RiftTitansMod.SkillStates.Chicken.SpawnState));
			CharacterDeathBehavior component3 = characterPrefab.GetComponent<CharacterDeathBehavior>();
			component3.deathState = new SerializableEntityStateType(typeof(RiftTitansMod.SkillStates.Chicken.DeathState));
			CharacterBody component4 = characterPrefab.GetComponent<CharacterBody>();
			component4.moveSpeed = 10f;
			...
			enemyMaster = CreateMaster(characterPrefab, "ChickenMaster");
			CreateSpawnCard();
		}

		private static GameObject CreateMaster(GameObject bodyPrefab, string masterName)
		{
			GameObject gameObject = PrefabAPI.InstantiateClone(Resources.Load<GameObject>("Prefabs/CharacterMasters/LemurianMaster"), masterName, true, "CreateMaster", "CreateMaster", 134);
			...
			aISkillDriver.customName = "Chase";
			...
			aISkillDriver.skillSlot = SkillSlot.None;
			aISkillDriver.shouldSprint = false;
			AISkillDriver aISkillDriver2 = gameObject.AddComponent<AISkillDriver>();
			aISkillDriver2.customName = "Shoot";
			...
			aISkillDriver2.minDistance = 15f;
			...
			aISkillDriver3.customName = "Flee";
			aISkillDriver3.movementType = AISkillDriver.MovementType.FleeMoveTarget;
			...
			aISkillDriver2.nextHighPriorityOverride = aISkillDriver3;
		...
		private static void CreateSpawnCard()
		{
			...
			characterSpawnCard.name = "cscChicken";
			...
			DirectorAPI.DirectorCardHolder chickenLoopCard = new DirectorAPI.DirectorCardHolder
			{
				Card = card2,
				MonsterCategory = DirectorAPI.MonsterCategory.BasicMonsters
			};
			RiftTitansPlugin.ChickenCard = relicCard;
			RiftTitansPlugin.ChickenLoopCard = chickenLoopCard;

			foreach (RiftTitansPlugin.StageSpawnInfo ssi in RiftTitansPlugin.StageList)
			{
				DirectorAPI.DirectorCardHolder toAdd = ssi.GetMinStages() == 0 ? RiftTitansPlugin.ChickenCard : RiftTitansPlugin.ChickenLoopCard;
		...
		private static void CreateSkills()
		{
			...
			skillDefInfo.activationState = new SerializableEntityStateType(typeof(Shoot));
			skillDefInfo.activationStateMachineName = "Body";
			skillDefInfo.baseMaxStock = 1;
			skillDefInfo.baseRechargeInterval = 0.8f;
			...
			skillDefInfo.baseRechargeInterval = 99999f;
			...
			Skills.AddSpecialSkill(characterPrefab, skillDef3);
		}
		...
		private static void InitializeItemDisplays()
		{
			...
			itemDisplayRuleSet.name = "idrsChicken";
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.0649f, 0.68079f, 0.22705f),
						localAngles = new Vector3(285.3459f, 76.63615f, 78.7606f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteHorn"),
						childName = "Head",
						localPos = new Vector3(0.20571f, 0.76165f, 0.14867f),
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.00597f, 1.36341f, 0.16901f),
						localAngles = new Vector3(304.5913f, 357.3275f, 187.2454f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteRhinoHorn"),
						childName = "Head",
						localPos = new Vector3(-0.01045f, 0.77721f, 0.2121f),
						localAngles = new Vector3(310.7944f, 2.13647f, 182.8755f),
						localScale = new Vector3(1f, 1f, 1f),
						limbMask = LimbFlags.None
					}
					}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.07215f, 0.39027f, 0.81761f),
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(0.00907f, 0.7133f, 0.44349f),
						localAngles = new Vector3(0f, 0f, 0f),
						localScale = new Vector3(0.2f, 0.2f, 0.3f),
						limbMask = LimbFlags.None
					}
					}
				}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.00033f, 0.81841f, 0.68296f),
						localAngles = new Vector3(0f, 0f, 180f),
						localScale = new Vector3(0.3f, 0.3f, 0.3f),
						limbMask = LimbFlags.None
					}

...
namespace RiftTitansMod.Modules.Survivors {
	...
	{
		internal static int spawnCost = 500;
		...
		public const string bodyName = "HeraldBody";
		...
		{
			bool flag = true;
			characterPrefab = Prefabs.CreatePrefab("HeraldBody", "mdlHerald", new BodyInfo
			{
				moveSpeed = 7.2f,
				acceleration = 30f,
				armor = 20f,
				armorGrowth = 0f,
				bodyName = "HeraldBody",
				bodyNameToken = "NDP_HERALD_BODY_NAME",
				bodyColor = Color.cyan,
				characterPortrait = Assets.LoadCharacterIcon("Herald"),
				...
				jumpCount = 0,
				maxHealth = 2300f,
				subtitleNameToken = "NDP_HERALD_BODY_SUBTITLE",
				podPrefab = Resources.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod"),
				cameraPivotPosition = new Vector3(0f, 9f, 0f),
				aimOriginPosition = new Vector3(0f, 4f, 0f)
			});
			Material material = Assets.CreateMaterial("matHerald", 6E-05f);
			bodyRendererIndex = 0;
			...
			component2.initialStateType = new SerializableEntityStateType(typeof(RiftTitansMod.SkillStates.Herald.SpawnState));
			CharacterDeathBehavior component3 = characterPrefab.GetComponent<CharacterDeathBehavior>();
			component3.deathState = new SerializableEntityStateType(typeof(RiftTitansMod.SkillStates.Herald.DeathState));
			...
			component8.barkSound = "HeraldIdle";
			EntityLocator entityLocator = characterPrefab.AddComponent<EntityLocator>();
			entityLocator.entity = characterPrefab;
			enemyMaster = CreateMaster(characterPrefab, "HeraldMaster");
			CreateSpawnCard();
		}

		private static GameObject CreateMaster(GameObject bodyPrefab, string masterName)
		{
			GameObject gameObject = PrefabAPI.InstantiateClone(Resources.Load<GameObject>("Prefabs/CharacterMasters/LemurianMaster"), masterName, true, "CreateMaster", "CreateMaster", 141);
			...
			gameObject.GetComponent<BaseAI>().aimVectorMaxSpeed = 300f;
			AISkillDriver aISkillDriver = gameObject.AddComponent<AISkillDriver>();
			aISkillDriver.customName = "Charge";
			...
			aISkillDriver.maxDistance = 75f;
			aISkillDriver.minDistance = 20f;
			...
			aISkillDriver3.customName = "Attack";
			...
			aISkillDriver3.maxDistance = 15f;
		...
		private static void CreateSpawnCard()
		{
			...
			characterSpawnCard.name = "cscHerald";
			...
			DirectorAPI.DirectorCardHolder heraldLoopCard = new DirectorAPI.DirectorCardHolder
			{
				Card = card2,
				MonsterCategory = DirectorAPI.MonsterCategory.Minibosses
			};
			RiftTitansPlugin.HeraldCard = spawnCard;
			RiftTitansPlugin.HeraldLoopCard = heraldLoopCard;

			foreach (RiftTitansPlugin.StageSpawnInfo ssi in RiftTitansPlugin.StageList)
			{
				DirectorAPI.DirectorCardHolder toAdd = ssi.GetMinStages() == 0 ? RiftTitansPlugin.HeraldCard : RiftTitansPlugin.HeraldLoopCard;
		...
		private static void CreateHitboxes()
		{
			...
			Transform hitboxTransform = componentInChildren.FindChild("Attack1");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "Attack1");
			hitboxTransform = componentInChildren.FindChild("Attack2");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "Attack2");
			hitboxTransform = componentInChildren.FindChild("Sweep");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "Sweep");
			hitboxTransform = componentInChildren.FindChild("Charge");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "Charge");
		}
		...
		private static void CreateSkills()
		{
			...
			skillDefInfo.activationState = new SerializableEntityStateType(typeof(Attack));
			...
			skillDefInfo.skillDescriptionToken = text + "_RELIC_BODY_SECONDARY_BUFFDISC_DESCRIPTION";
			skillDefInfo.skillIcon = Assets.mainAssetBundle.LoadAsset<Sprite>("texLunarEncore1Icon");
			skillDefInfo.activationState = new SerializableEntityStateType(typeof(Sweep));
			skillDefInfo.activationStateMachineName = "Body";
			skillDefInfo.baseMaxStock = 1;
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						localAngles = new Vector3(317.8962f, 169.802f, 311.0157f),
					...
					new ItemDisplayRule
					{
						...
						localAngles = new Vector3(318.6926f, 245.6709f, 349.3334f),
						localScale = new Vector3(1.5f, 1.5f, 1.5f),
						limbMask = LimbFlags.None
					}
					}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.02065f, 0.92408f, 1.97907f),
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						localScale = new Vector3(0.6f, 0.3f, 0.6f),
						limbMask = LimbFlags.None
					}
					}
				}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.04862f, 0.58871f, 1.84355f),

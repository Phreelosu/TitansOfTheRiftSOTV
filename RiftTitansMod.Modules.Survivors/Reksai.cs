...
namespace RiftTitansMod.Modules.Survivors {
	...
	public static class Reksai
	{
		internal static int spawnCost = 400;
		...
		public const string bodyName = "ReksaiBody";
		...
		{
			bool flag = true;
			characterPrefab = Prefabs.CreatePrefab("ReksaiBody", "mdlReksai", new BodyInfo
			{
				moveSpeed = 13f,
				acceleration = 30f,
				armor = 10f,
				armorGrowth = 0f,
				bodyName = "ReksaiBody",
				bodyNameToken = "NDP_REKSAI_BODY_NAME",
				bodyColor = Color.cyan,
				characterPortrait = Assets.LoadCharacterIcon("Reksai"),
				...
				jumpCount = 1,
				maxHealth = 2000f,
				subtitleNameToken = "NDP_REKSAI_BODY_SUBTITLE",
				podPrefab = Resources.Load<GameObject>("Prefabs/NetworkedObjects/SurvivorPod"),
				cameraPivotPosition = new Vector3(0f, 8f, 0f),
				aimOriginPosition = new Vector3(0f, 8f, 0f)
			});
			Material material = Assets.CreateMaterial("matReksai");
			bodyRendererIndex = 0;
			...
			component2.initialStateType = new SerializableEntityStateType(typeof(RiftTitansMod.SkillStates.Reksai.SpawnState));
			CharacterDeathBehavior component3 = characterPrefab.GetComponent<CharacterDeathBehavior>();
			component3.deathState = new SerializableEntityStateType(typeof(RiftTitansMod.SkillStates.Reksai.DeathState));
			CharacterBody component4 = characterPrefab.GetComponent<CharacterBody>();
			component4.moveSpeed = 13f;
			...
			FootstepHandler component6 = characterPrefab.GetComponent<ModelLocator>().modelTransform.gameObject.GetComponent<FootstepHandler>();
			component6.baseFootstepString = "Play_beetle_queen_step";
			component6.footstepDustPrefab = Resources.Load<GameObject>("Prefabs/GenericLargeFootstepDust");
			SfxLocator component7 = characterPrefab.GetComponent<SfxLocator>();
			component7.deathSound = "RekDeath";
			component7.barkSound = "RekIdle";
			component7.fallDamageSound = string.Empty;
			component7.landingSound = string.Empty;
			characterPrefab.AddComponent<ReksaiBurrowController>();
			characterPrefab.AddComponent<ReksaiSpecialTracker>();
			EntityLocator entityLocator = characterPrefab.AddComponent<EntityLocator>();
			entityLocator.entity = characterPrefab;
			enemyMaster = CreateMaster(characterPrefab, "ReksaiMaster");
			CreateSpawnCard();
		}

		private static GameObject CreateMaster(GameObject bodyPrefab, string masterName)
		{
			GameObject gameObject = PrefabAPI.InstantiateClone(Resources.Load<GameObject>("Prefabs/CharacterMasters/LemurianMaster"), masterName, true, "CreateMaster", "CreateMaster", 142);
			...
			aISkillDriver.customName = "Special";
			...
			aISkillDriver2.customName = "Seeker";
			...
			aISkillDriver2.maxDistance = 200f;
			aISkillDriver2.minDistance = 30f;
			...
			aISkillDriver.nextHighPriorityOverride = aISkillDriver2;
			AISkillDriver aISkillDriver3 = gameObject.AddComponent<AISkillDriver>();
			aISkillDriver3.customName = "ChaseHard";
			...
			aISkillDriver3.maxDistance = 30f;
			aISkillDriver3.minDistance = 14f;
			...
			aISkillDriver4.customName = "Attack";
			...
			aISkillDriver4.maxDistance = 14f;
			aISkillDriver4.minDistance = 0f;
			aISkillDriver4.requireSkillReady = false;
			aISkillDriver4.aimType = AISkillDriver.AimType.AtCurrentEnemy;
			aISkillDriver4.ignoreNodeGraph = true;
			aISkillDriver4.moveInputScale = 1f;
			aISkillDriver4.driverUpdateTimerOverride = 0.1f;
			...
			aISkillDriver5.customName = "Chase";
		...
		private static void CreateSpawnCard()
		{
			...
			characterSpawnCard.name = "cscReksai";
			...
			DirectorAPI.DirectorCardHolder reksaiLoopCard = new DirectorAPI.DirectorCardHolder
			{
				Card = card2,
				MonsterCategory = DirectorAPI.MonsterCategory.Minibosses
			};
			RiftTitansPlugin.ReksaiCard = relicCard;
			RiftTitansPlugin.ReksaiLoopCard = reksaiLoopCard;

			foreach (RiftTitansPlugin.StageSpawnInfo ssi in RiftTitansPlugin.StageList)
			{
				DirectorAPI.DirectorCardHolder toAdd = ssi.GetMinStages() == 0 ? RiftTitansPlugin.ReksaiCard : RiftTitansPlugin.ReksaiLoopCard;
		...
		private static void CreateHitboxes()
		{
			...
			Transform hitboxTransform = componentInChildren.FindChild("SwipeRight");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "SwipeRight");
			hitboxTransform = componentInChildren.FindChild("SwipeLeft");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "SwipeLeft");
			hitboxTransform = componentInChildren.FindChild("Uppercut");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "Uppercut");
			hitboxTransform = componentInChildren.FindChild("SpecialHitbox");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "Special");
			hitboxTransform = componentInChildren.FindChild("UnburrowHitbox");
			Prefabs.SetupHitbox(gameObject, hitboxTransform, "Unburrow");
		}
		...
		private static void CreateSkills()
		{
			...
			skillDefInfo.baseRechargeInterval = 1.25f;
			...
			skillDefInfo.activationState = new SerializableEntityStateType(typeof(Unburrow));
			skillDefInfo.activationStateMachineName = "Body";
			skillDefInfo.baseMaxStock = 1;
			...
			skillDefInfo.requiredStock = 1;
			skillDefInfo.stockToConsume = 1;
			unburrowSkillDef = Skills.CreateSkillDef(skillDefInfo);
			...
			skillDefInfo.activationState = new SerializableEntityStateType(typeof(PlaceTentacles));
			skillDefInfo.activationStateMachineName = "Body";
			skillDefInfo.baseMaxStock = 0;
			skillDefInfo.baseRechargeInterval = 100000000f;
			...
			Skills.AddUtilitySkill(characterPrefab, skillDef3);
			skillDefInfo = new SkillDefInfo();
		...
		private static void InitializeItemDisplays()
		{
			...
			itemDisplayRuleSet.name = "idrsReksaiEnemy";
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.39349f, -0.79459f, 0.50535f),
						localAngles = new Vector3(285.3459f, 76.63615f, 78.76059f),
					...
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteHorn"),
						childName = "Head",
						localPos = new Vector3(0.65715f, -0.74233f, 0.40126f),
						localAngles = new Vector3(315.1687f, 283.9656f, 270.1197f),
						localScale = new Vector3(0.7f, 0.7f, 0.7f),
						limbMask = LimbFlags.None
					}
					}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.06241f, -0.32829f, 0.68001f),
						localAngles = new Vector3(31.12082f, 1.63086f, 179.6649f),
						localScale = new Vector3(3f, 3f, 2.6f),
						limbMask = LimbFlags.None
					},
					new ItemDisplayRule
					{
						...
						followerPrefab = ItemDisplays.LoadDisplay("DisplayEliteRhinoHorn"),
						childName = "Head",
						localPos = new Vector3(-0.00049f, 0.00776f, 0.0019f),
						localAngles = new Vector3(331.756f, 357.9318f, 354.5345f),
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.00187f, -1.42859f, 0.33346f),
						localAngles = new Vector3(90f, 180f, 0f),
						localScale = new Vector3(0.27f, 0.2f, 0.27f),
						limbMask = LimbFlags.None
					}
					}
				}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(0.00907f, -1.00392f, 0.44354f),
						localAngles = new Vector3(90f, 181.2041f, 0f),
						localScale = new Vector3(0.3f, 0.25f, 0.5f),
						limbMask = LimbFlags.None
					}
					}
				}
			...
			itemDisplayRules.Add(new ItemDisplayRuleSet.KeyAssetRuleGroup
			{
				...
				displayRuleGroup = new DisplayRuleGroup
				{
					...
					new ItemDisplayRule
					{
						...
						childName = "Head",
						localPos = new Vector3(-0.00033f, -1.45818f, -0.00332f),
						localAngles = new Vector3(270f, 0f, 0f),
